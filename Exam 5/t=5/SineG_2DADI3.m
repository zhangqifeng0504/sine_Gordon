...
psi = @(x,y) 4.13*(sech((4-sqrt((x+3).^2+(y+3).^2))/0.436))+4.13*(sech((4-sqrt((x+17).^2+(y+3).^2))/0.436))+...
    4.13*(sech((4-sqrt((x+3).^2+(y+17).^2))/0.436))+4.13*(sech((4-sqrt((x+17).^2+(y+17).^2))/0.436));
psixx = @(x,y) 4.13/(0.436^2)*(sech((4-sqrt((x+3).^2+(y+3).^2))/0.436).*((x+3).^2./((x+3).^2+(y+3).^2))+...
    0.436*sech((4-sqrt((x+3).^2+(y+3).^2))/0.436).*tanh((4-sqrt((x+3).^2+(y+3).^2))/0.436).*((y+3).^2./((x+3).^2+(y+3).^2).^(3/2)))+...
    4.13/(0.436^2)*(sech((4-sqrt((x+17).^2+(y+3).^2))/0.436).*((x+17).^2./((x+17).^2+(y+3).^2))+...
    0.436*sech((4-sqrt((x+17).^2+(y+3).^2))/0.436).*tanh((4-sqrt((x+17).^2+(y+3).^2))/0.436).*((y+3).^2./((x+17).^2+(y+3).^2).^(3/2)))+...
    4.13/(0.436^2)*(sech((4-sqrt((x+3).^2+(y+17).^2))/0.436).*((x+3).^2./((x+3).^2+(y+17).^2))+...
    0.436*sech((4-sqrt((x+3).^2+(y+17).^2))/0.436).*tanh((4-sqrt((x+3).^2+(y+17).^2))/0.436).*((y+17).^2./((x+3).^2+(y+17).^2).^(3/2)))+...
    4.13/(0.436^2)*(sech((4-sqrt((x+17).^2+(y+17).^2))/0.436).*((x+17).^2./((x+17).^2+(y+17).^2))+...
    0.436*sech((4-sqrt((x+17).^2+(y+17).^2))/0.436).*tanh((4-sqrt((x+17).^2+(y+17).^2))/0.436).*((y+17).^2./((x+17).^2+(y+17).^2).^(3/2)));
psiyy = @(x,y) 4.13/(0.436^2)*(sech((4-sqrt((x+3).^2+(y+3).^2))/0.436).*((x+3).^2./((x+3).^2+(y+3).^2))+...
    0.436*sech((4-sqrt((x+3).^2+(y+3).^2))/0.436).*tanh((4-sqrt((x+3).^2+(y+3).^2))/0.436).*((y+3).^2./((x+3).^2+(y+3).^2).^(3/2)))+...
    4.13/(0.436^2)*(sech((4-sqrt((x+17).^2+(y+3).^2))/0.436).*((x+17).^2./((x+17).^2+(y+3).^2))+...
    0.436*sech((4-sqrt((x+17).^2+(y+3).^2))/0.436).*tanh((4-sqrt((x+17).^2+(y+3).^2))/0.436).*((y+3).^2./((x+17).^2+(y+3).^2).^(3/2)))+...
    4.13/(0.436^2)*(sech((4-sqrt((x+3).^2+(y+17).^2))/0.436).*((x+3).^2./((x+3).^2+(y+17).^2))+...
