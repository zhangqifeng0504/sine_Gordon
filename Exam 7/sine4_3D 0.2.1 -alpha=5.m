...
u1 =SineG_3DADI2(xa,xb,ya,yb,za,zb,ta,0.9,m1,m2,m3,n,alpha,beta,gamma,theta);
u1 = sin(u1/2);
for l =1:m3+1
u1(1:m1+1,1:m1+1,l)=u1(1:m1+1,1:m1+1,l)';
end
p = patch(isosurface(x,y,z,u1,0.2));
...
title  ({'${\rm isosurfaces ~of ~\sin(u/2) = 0.2~ at~ t=0.9}$'},'FontUnits','points','interpreter','latex','FontSize',15,'FontName','Times')
