...
u1 =SineG_3DADI2(xa,xb,ya,yb,za,zb,ta,2.4,m1,m2,m3,n,alpha,beta,gamma,theta);
u1 = sin(u1/2);
for l =1:m3+1
...
title  ({'${\rm isosurfaces ~of ~\sin(u/2) = 0.6~ at~ t=2.4}$'},'FontUnits','points','interpreter','latex','FontSize',15,'FontName','Times')
