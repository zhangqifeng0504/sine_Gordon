...
u1 =SineG_3DADI2(xa,xb,ya,yb,za,zb,ta,5,m1,m2,m3,n,alpha,beta,gamma,theta);
u1 = sin(u1/2);
...
title  ({'${\rm isosurfaces ~of ~\sin(u/2) = 0.2~ at~ t=5}$'},'FontUnits','points','interpreter','latex','FontSize',15,'FontName','Times')
