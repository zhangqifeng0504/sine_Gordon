...
%% 
u5 =SineG_2DADI3(xa,xb,ya,yb,ta,15,m1,m2,n,alpha,beta,theta);
u5 = sin(u5/2);
contour(x,y,u5', 20, 'LineWidth', 0.8);
...
title   ({'$\sin(u/2),t=15$'},'FontUnits','points','interpreter','latex','FontSize',15,'FontName','Times')
